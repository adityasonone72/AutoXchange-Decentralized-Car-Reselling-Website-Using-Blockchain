    ...
    const getRequests = async () =>{
      ...
      for(let i=0; i<_totalIndices; i++){
        ...
        if(ownerOwns[3].words[0] != 0){
          ...
          const carRegistrationID = reqCnt_propId[1].words[0];
          ...
          if(noOfRequests > 0){
            ...
            for(let j = 0; j<noOfRequests; j++){
              ...
              const reqDetails = {state: ownerOwns[0], district: ownerOwns[1], city: ownerOwns[2], pinCode: ownerOwns[3].words[0], index: i, reqNo: j, requester, carRegistrationID}
          ...
          requestList.map((details, index) =>{
            return(
              <DisplayRequests
                ...
                key = {index}
                carRegistrationID = {details.carRegistrationID}
                ...
                firstregistrationdate = {details.firstregistrationdate}
